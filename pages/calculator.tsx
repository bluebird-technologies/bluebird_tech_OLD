...
function Calculator() {
  ...
  const initalValues: CalculatorContextType = {
    platform: '',
    optimisticHours: 0,
    pessimisticHours: 0,
    resources: [''],
  ...
  const [calculatorValues, setCalculatorValues] = useState<CalculatorContextType>(initalValues);
  return (
    <CalculatorContext.Provider value={calculatorValues}>
