...
export function WhatWeOffer() {
  return (
    <div className="mt-[78px] mb-[91px] flex w-full flex-1 flex-col items-center justify-center lg:-mx-[16px] lg:flex-row  lg:flex-wrap lg:gap-y-[32px] ">
      ...
      {items.map((i, index) => {
        const data = { label: i.label };
        return (
          <div
            key={index}
            className="mt-4 w-[300px] items-center justify-center lg:mx-0 lg:mt-0 lg:w-1/4"
          >
            <Link href={{ pathname: '/offer', query: data }}>
              <div className="flex lg:h-52 flex-row items-center justify-start rounded-[25px] px-[20px] pt-[22px] pb-[18px] shadow-[2px_4px_16px_#00000029] transition-all hover:-mt-2 lg:mx-[16px] lg:flex-col lg:items-start">
