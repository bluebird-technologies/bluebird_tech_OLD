...
export function IntroAndChallengeSection({
  ...
  return (
    <>
      <div className="relative flex flex-col w-full max-w-6xl items-center justify-center md:bg-transparent">
        <h1 className="hidden md:block text-white uppercase font-bold text-5xl mt-16">
          {clientName}
        </h1>
        <div className="flex flex-col items-center px-8 lg:px-0">
          <p className="text-white font-normal text-sm md:text-2xl text-center mt-0 md:mt-16">
            {problem}
          </p>
          <p className="text-highlight max-w-4xl font-normal text-sm md:text-2xl text-center mt-6 md:mt-16">
            {solution}
          </p>
        </div>

        <div className="hidden md:block">{VerticalScribbles}</div>
      </div>
      <div className="hidden md:flex w-full max-w-7xl justify-center px-4 md:pt-24">
      ...
      <div className="md:hidden flex flex-col w-full justify-center items-center mt-8">
      ...
      <div className="text-xl max-w-6xl mt-20">
        {challenges.map((item, key) => (
          <div key={key} className="md:pr-6">
            <div className="hidden md:flex flex-row items-start mb-16">
              <Lottie
            ...
            <div className="md:hidden flex flex-row items-start px-12 mb-12">
              <div>
        ...
        <div className="flex flex-row flex-wrap w-full justify-center md:justify-between mb-6 md:px-2 xl:px-0">
          {services.map((item, key) => (
            <a
              key={key}
              className="text-white border text-center rounded-full py-2 mr-2 px-4 my-3 mx-4 md:mx-0"
            >
              {item}
            </a>
          ))}
